...
<head>
    ...
    <title>Wallet-Q - Dashboard</title>
...
<body>
    <div class="header">
        <img src="img/wall.png" width="25px" height="25px" class="float-left logo-fav">
        ...
        <a href="logout">
            <div class="logout">
                ...
                <p class="float-right logout">KELUAR</p>
            </div>
        </a>
    </div>
    ...
    <div class="sidebar">
        <nav>
            <ul>
                <li class="rentang">
                    <img src="img/saskeh.png" class="img-fluid profile float-left" width="60px">
                ...
                <a href="dashboard" style="text-decoration: none;">
                    <li class="aktif" style="border-left: 5px solid #bac2d6;">
                        <div>
                ...
                <div class="container" id="container" style="border: none;">
                    <div class="row tampilCardview" id="row">
                        ...
                        <div class="col-md-4 jarak">
                            <div class="card card-stats card-warning" style="background: #0c4fed;">
                                <div class="card-body ">
                                    <div class="row">
                                        <div class="col-5">
                        ...
                        <div class="col-md-4 jarak">
                            <a href="tambahPengeluaran" style="text-decoration: none;">
                                <div class="card card-stats card-warning" style="background: #cf0e0e;">
                                    <div class="card-body ">
                                        <div class="row">
                                            <div class="col-5">
                                                <div class="icon-big text-center">
                                ...
                                <div class="overlay" style="background: #cf0e0e;">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-5">
                                                <div class="icon-big text-center">
                        ...
                        <div class="col-md-4 jarak">
                            <a href="tambahPemasukkan" style="text-decoration: none;">
                                <div class="card card-stats card-warning" style="background: #1ed61a;">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-5">
                                                <div class="icon-big text-center">
                                ...
                                <div class="overlay" style="background: #1ed61a;">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-5">
                                                <div class="icon-big text-center">
