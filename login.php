          ...
          <div class="col-sm-6 p-0">
            <div class="card">
              <div class="card-header">
                ...
                <div class="sub-title">Registrasi untuk gunakan Wallet-Q</div>
              </div>
          ...
          <div class="col-sm-6 p-0">
            <div class="card">
              <div class="card-header">
                ...
                <div class="sub-title">Masuk untuk gunakan Wallet-Q</div>
              </div>
              <div class="icon-user">
                <h4 class="fa fa-user"></h4>
              </div>
              ...
              <div class="card-body">
                <form method="POST">
                  ...
                  <button type="submit" name="login" class="btn btn-primary" style="margin-top: -15px">Masuk</button>
                </form>
              </div>
            </div>
          </div>
