...
<head>
    ...
    <link rel="shortcut icon" href="img/wall.png">
    <title>Wallet-Q</title>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top main-nav" id="mainNav">
        <div class="container">
            ...
            <a class="navbar-brand js-scroll-trigger" href="#page-top">Undip Team</a>
    ...
    <header id="home" class="text-light parallax">
        <div class="container konten">
            <h1 style="font-size: 36pt;">SELAMAT DATANG di Wallet-Q</h1>
            <p class="lead" style="font-size: 16pt;">Aplikasi pencatatan keuangan harian dengan
                fitur
                transaksi terbaik</p>
            <a href="login" class="btn btn-outline-light button">Ayo Mulai</a>
        </div>
    </header>
    <!-- header -->
    ...
    <section id="features" class="bg-light">
        <div class=" container konten2">
            ...
            <div class="col-lg-12 foot-fitur">
                <h4 class="headline text-center">Wallet-Q</h4>
                <p class="isi-fitur text-center">Wallet-Q adalah aplikasi web pencatatan keuangan harian yang
            ...
            <div class="row row2">
                <div class="col-lg-6 fiturs">
                    <div class="gbr">
                        <div class="box">
                            <img src="img/trans.jpg" class="gambar-fitur img" width="100%">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 fiturs">
            ...
            <div class="row row2">
                ...
                <div class="col-lg-6 fiturs">
                    <div class="gbr">
                        <div class="box">
                            <img src="img/priba.jpg" class="gambar-fitur img" width="100%">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="about" class="bg-primary parallax2">
        <div class="container">
            <div style="color: white;" class="garis garis3 text-center">UNDIP TEAM</div>
            <div class="row text-center">
                <div class="col-lg-4">
                    <div class="team">
                        <div class="gbr">
                            <div class="box">
                                <img class="img" src="profile/kuda.jpg" width="100%">
                            </div>
                        </div>
                        <div class="teks">
                            <h3 class="job-desk">Team Leader</h3>
                            <p>Yoel Kamban Dali</p>
                            <p>Akuntansi Undip 22 - Ngesrep Kece</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="team">
                        <div class="gbr">
                            <div class="box">
                                <img class="img" src="profile/dipo.jpg" width="100%">
                            </div>
                        </div>
                        <div class="teks">
                            <h3 class="job-desk">UI/UX Designer</h3>
                            <p>Nadia Gita Maharani
                            <p>Akuntansi Undip 22 - Jatingaleh Macet</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="team">
                        ...
                        <div class="teks">
                            ...
                            <p>Dian Anggreni</p>
                            <p>Akuntansi Undip 22 - Bulusan Pinggiran</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <div class="garis garis2 text-center">Hubungi Kami</div>
                    <div class="row text-center">
                        <div class="col col1">
        ...
        <div class="container text-light">
            <div class="row">
                ...
                <div class="col-lg-3 col-6 p-3">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li> <a href="#" class="foot-link">Promosi Video</a> </li>
                    </ul>
                </div>
                <div class="col-lg-3 col-md-6 p-3">
                    <h5> <b>Tentang</b> </h5>
                    <p class="mb-0">Aplikasi Wallet-Q dilengkapi dengan fitur menarik yang dapat mempermudah user mengelola keuangannya.</p>
                </div>
                <div class="col-lg-3 col-md-6 p-3">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <p class="mb-0 mt-2">HakCipta © 2024 Wallet-Q. Semua Hak Cipta</p>
                </div>
            </div>
        </div>
    </div>
